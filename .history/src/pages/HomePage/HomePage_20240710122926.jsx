  ...
  return (
    <div className="relative min-h-screen bg-cover bg-center flex flex-col items-center justify-center" style={{ backgroundImage: 'url(https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/9a145268-41e7-4aa6-93b1-564a57fd6f05/dbki5lx-bc7ebf79-b427-4bb7-b19f-d1cf46b926a1.jpg/v1/fill/w_1024,h_698,q_75,strp/soccer_stadium_by_hz_designs_dbki5lx-fullview.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..JWmyDxBn2RMSKNo8_ri8MLbEyraknjoe5rTuY5QYWYc)' }}>
      ...
      <div className="relative z-10 flex flex-col items-center text-center text-white p-6">
        ...
        <p className="text-lg md:text-2xl p-2 mb-8 ">A Field of Grace is a fundraising event organized by Phronesis Ministry to support various orphan homes. The event promises an exciting program featuring renowned Christian musicians and influencers. Join us for an inspiring and uplifting experience as we come together to make a difference in the lives of children in need.</p>
        <p className="text-lg md:text-2xl p-2 mb-8 bg-purple-600">Join us for an unforgettable experience. Register for free now to participate!</p>
        <button
